...
dt = joblib.load('treeSharmaTemprangeTrain.sav')
...
plt.savefig('currentLakeMapSharmaTemprange.png', bbox_inches='tight')
plt.clf()
...
plt.savefig('warmingLakeMapSharmaTemprange.png', bbox_inches='tight')
plt.clf()
