...
lakeData = lakeData[['MeanAnnualAirTemp_c',  'MeanDepth_m', 'Elevation_m', 'ShorelineDevelopment', 'temp_range']]
...
dt = joblib.load('treeSharmaTemprangeGood.sav')
...
plt.savefig('currentLakeMapSharmaTemprangeGood.png', bbox_inches='tight')
plt.clf()
...
plt.savefig('warmingLakeMapSharmaTemprangeGood.png', bbox_inches='tight')
plt.clf()
