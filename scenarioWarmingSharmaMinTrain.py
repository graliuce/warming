...
dt = joblib.load('treeSharmaMinTrain.sav')
...
plt.savefig('currentLakeMapSharmaMinTrain.png', bbox_inches='tight')
plt.clf()
...
plt.savefig('warmingLakeMapSharmaMinTrain.png', bbox_inches='tight')
plt.clf()
