...
glakeData = glakeData.drop(['Lake_name', 'Country', 'Continent', 'Vol_src', 'winter_tmp', 'Res_time', 'Dis_avg', 'Shore_len', 'Shore_dev', 'Slope_100', 'Wshd_area', 'Pour_long'], axis = 1)
...
glakeData = glakeData.rename(columns={'Depth_avg':'MeanDepth_m',  'Pour_lat': 'Latitude_dd', 'Lake_area':'SurfaceArea_km2', 'Elevation':'Elevation_m', 'Vol_total':'Volume_mcm', 'mean_temp': 'MeanAnnualAirTemp_c'})
...
lakeData = lakeData[['Latitude_dd', 'Elevation_m', 'MeanAnnualAirTemp_c', 'SurfaceArea_km2', 'MeanDepth_m', 'Volume_mcm', 'temp_range', 'tmx', 'tmn']]
...
plt.savefig('currentLakeMap.png', bbox_inches='tight')
plt.clf()
...
plt.savefig('warmingLakeMap.png', bbox_inches='tight')
plt.clf()
